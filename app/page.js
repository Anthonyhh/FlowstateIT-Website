...
export default function FlowStateIT() {
  ...
  return (
    <div className="min-h-screen bg-[#14141C] text-neutral-50">
      ...
      {/* Hero Section */}
      <section className="relative min-h-[85vh] flex items-start pt-2 md:pt-3">
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 pt-4 pb-2 md:pt-6 md:pb-3 relative z-10">
