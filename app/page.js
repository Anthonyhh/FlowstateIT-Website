...
export default function FlowStateIT() {
  ...
  return (
    <div className="min-h-screen bg-[#14141C] text-neutral-50">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                ...
                <Button 
                  ...
                  size="lg"
                  variant="outline"
                  className="border-2 border-white/20 text-white hover:bg-white/5 hover:border-white/40 hover:text-white px-8 py-6 text-lg font-semibold rounded-lg"
                >
                  View Services
                </Button>
              </div>
      ...
      {/* Process Section */}
      <section id="process" className="py-24 md:py-32 bg-neutral-900/30">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
      ...
      <section id="quiz" className="py-24 md:py-32 bg-neutral-900/30">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
